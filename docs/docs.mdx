...
The `onRotationChange` callback allows you to synchronize external effects with the parallax rotation. In this example, a `boxShadow` moves in the opposite direction of the card tilt, simulating a light source from above.
